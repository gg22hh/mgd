...
export const Quiz = ({userData}) => {
	const [headElem, setHeadElem] = useState(document.getElementById('head'))
	const [buttonsElem, setButtonsElem] = useState(document.getElementById('buttons'))
	const [pagesElem, setPagesElem] = useState(document.getElementById('pages'))
  useEffect(() => {
    if (!buttonsElem || !headElem || !pagesElem) {
			setHeadElem(document.getElementById('head'))
			setButtonsElem(document.getElementById('buttons'))
			setPagesElem(document.getElementById('pages'))
		}
  }, [buttonsElem, pagesElem, headElem]);
  class Quiz {
  ...
  if (headElem && buttonsElem && pagesElem) {
    Update();
  }
    ...
    <div className="wrapper">
      <main className="main">
        <div className="quiz__head">
					<div className="user__name">{userData ? userData.displayName : <strong>Авторизуйтесь на главной странице</strong>}</div>
          <div className="head__content" id="head">
        ...
        <div className="quiz__body">
          <div className="buttons">
            <div className="buttons__content" id="buttons">
              <button className="button">Default button</button>
              <br />
              <button className="button button_wrong">Wrong answer</button>
              <br />
              <button className="button button_correct">Correct answer</button>
              <br />
          ...
          <div className="quiz__footer">
            <div className="footer__content" id="pages">
              0 / 0
            </div>
          </div>
        </div>
